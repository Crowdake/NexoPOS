                ...
                <tbody class="text-sm">
                    ...
                    <tr>
                        <td colspan="2" class="p-2 border-b border-gray-700">
                            ...
                            <br>
                            <span class="text-xs">{{ $product->unit->name }}</span> &mdash; <span class="text-xs text-gray-600">{{ __( 'Condition:' ) }} {{ $ordersService->getRefundedOrderProductLabel( $product->condition ) }}
                        </td>
